...
- `infografia-ruta-desarrollo-social-geogreen-gptimage.png`: visión general de
  los cuatro momentos liderados por Desarrollo Social, su libertad metodológica
  y la continuidad obligatoria de los entregables; el archivo `.prompt.md`
  contiguo conserva el brief y el prompt reproducible.
