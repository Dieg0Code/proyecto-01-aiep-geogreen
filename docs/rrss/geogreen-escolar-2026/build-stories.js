...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <g transform="translate(72 520)">
    <rect x="0" y="-42" width="324" height="50" rx="25" fill="#E51B2A"/>
    <text x="162" y="-9" text-anchor="middle" fill="#FFFFFF" font-family="Arial"
      font-size="21" font-weight="700" letter-spacing="1.4">GEOGREEN ESCOLAR 2026</text>
  ...
  <g transform="translate(72 1202)" filter="url(#shadow)">
    <rect x="0" y="0" width="936" height="250" rx="30" fill="#07345E" fill-opacity=".96"
      stroke="#E51B2A" stroke-width="2"/>
