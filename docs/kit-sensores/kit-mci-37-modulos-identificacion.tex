...
\fancyfoot[L]{\small\textcolor{AIEPSlate}{GeoGreen · Kit MCI de 37 módulos · Manual de identificación}}
...
{\color{white}\Huge\bfseries Kit MCI de 37 módulos}\\[2mm]
...
\textbf{Contenido verificado.} Este manual corresponde al \textbf{Kit de 37 Sensores para Arduino de MCI}
(SKU \texttt{MCI05260}): 26 sensores y 11 actuadores. El inventario se contrastó con la ficha oficial del proveedor.
\href{https://mcielectronics.cl/shop/product/kit-de-37-sensores-para-arduino-mci-electronics-25339/}{\textcolor{AIEPRed}{\textbf{Ver ficha del kit en MCI $\rightarrow$}}}
\end{infobox}
...
\begin{multicols}{2}
\footnotesize
\textbf{\textcolor{AIEPNavy}{A. Movimiento y control}}\\
KY-040 · KY-023\par
\textbf{\textcolor{AIEPNavy}{B. Inclinación, vibración e impacto}}\\
KY-002 · KY-017 · KY-020 · KY-031\par
\textbf{\textcolor{AIEPNavy}{C. Magnéticos y efecto Hall}}\\
KY-003 · KY-024 · KY-035 · KY-021 · KY-025\par
\textbf{\textcolor{AIEPNavy}{D. LEDs (salida de luz)}}\\
KY-009 · KY-011 · KY-016 · KY-029 · KY-034 · KY-027\par
\textbf{\textcolor{AIEPNavy}{E. Ópticos e infrarrojo}}\\
KY-018 · KY-010 · KY-008 · KY-005 · KY-022 · KY-032 · KY-033 · KY-026\par
\textbf{\textcolor{AIEPNavy}{F. Sonido}}\\
KY-006 · KY-012 · KY-037 · KY-038\par
\textbf{\textcolor{AIEPNavy}{G. Temperatura y humedad}}\\
KY-001 · KY-013 · KY-028 · KY-015\par
\textbf{\textcolor{AIEPNavy}{H. Interacción y actuadores}}\\
...
% ===================== A =====================
\section{A · Movimiento y control}
...
% ===================== B =====================
\section{B · Inclinación, vibración e impacto}
...
% ===================== C =====================
\section{C · Magnéticos y efecto Hall}
...
% ===================== E =====================
\section{E · Ópticos e infrarrojo}
...
% ===================== G =====================
\section{G · Temperatura y humedad}
...
% ===================== H =====================
\section{H · Interacción y actuadores}
...
\textbf{Seguridad.} El \textbf{relé KY-019} puede conmutar voltajes peligrosos: cualquier trabajo
con tensión de red requiere supervisión docente. El \textbf{láser KY-008} no debe apuntarse a los ojos.
Los módulos \textbf{KY-017} y \textbf{KY-027} contienen mercurio: evita golpes, no los abras y
retíralos de uso si la cápsula de vidrio presenta daño.
\end{infobox}
