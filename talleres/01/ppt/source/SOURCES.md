# Fuentes de imágenes - Taller 01

Imágenes usadas como base visual del PPT del Taller 1. Se guardan localmente en
`assets/images/` para que el deck pueda reconstruirse sin depender de la red.

| Archivo local | Fuente | Autor / licencia |
|---|---|---|
| `recycling-bins-orchard-road.jpg` | https://commons.wikimedia.org/wiki/File:NEA_recycling_bins,_Orchard_Road.JPG | Terence Ong · licencias indicadas en Wikimedia Commons |
| `school-recycling-bin-lagos.jpg` | https://commons.wikimedia.org/wiki/File:Recycling_bin_at_junior_high_school_in_Lagos.jpg | PhenomKenny · CC BY-SA 4.0 |
| `school-recycling-bin-lagos-crop.jpg` | Recorte local de `school-recycling-bin-lagos.jpg` | Mismo origen y licencia |
| `school-recycling-bin-lagos-bin-focus.jpg` | Recorte local de `school-recycling-bin-lagos.jpg` | Mismo origen y licencia |
